...
if (isset($_GET["q"])) {
    ...
    if ($keyDate == $DateInTable) {
        ...
        $AdminMessage .= '<a href="http:' . DOMAIN . $PATH_PARTS["dirname"] . '/admin/approve.php?q=' . $keyId . '">Approve Registration</a></p>';
        $AdminMessage .= "<p>or copy and paste this url into a web browser: ";
        $AdminMessage .= 'http:' . DOMAIN . $PATH_PARTS["dirname"] . '/admin/approve.php?q=' . $keyId . "</p>";
